...
curl -sL https://github.com/wshobson/agents/raw/main/plugins/codebase-cleanup/agents/code-reviewer.md -o .claude/agents/code-reviewer.md
```

## Notes
Extracted from [`wshobson/agents`](https://github.com/wshobson/agents/blob/main/plugins/codebase-cleanup/agents/code-reviewer.md). Plugin: `codebase-cleanup`. Pending verify -> promote.
