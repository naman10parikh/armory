...
curl -sL https://github.com/wshobson/agents/raw/main/plugins/error-debugging/agents/error-detective.md -o .claude/agents/error-detective.md
```

## Notes
Extracted from [`wshobson/agents`](https://github.com/wshobson/agents/blob/main/plugins/error-debugging/agents/error-detective.md). Plugin: `error-debugging`. Pending verify -> promote.
