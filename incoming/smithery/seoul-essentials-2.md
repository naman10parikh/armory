...
source_repo: 
source_url: https://smithery.ai/servers/do-droid/seoul-essentials
license: unknown
...
See [Smithery](https://smithery.ai/server/do-droid/seoul-essentials) for the install config.
