...
source_repo: 
source_url: https://smithery.ai/servers/wangtsiao/pulse-cn-mcp
license: unknown
...
See [Smithery](https://smithery.ai/server/wangtsiao/pulse-cn-mcp) for the install config.
