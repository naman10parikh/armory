...
source_repo: 1mcp-app/agent
source_url: https://github.com/1mcp-app/agent
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/1mcp-app/agent

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/1mcp-agent). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
