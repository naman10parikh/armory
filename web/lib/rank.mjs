...
const METRIC_LABEL = { stars: "stars", tested: "tested", mentions: "mentions", forks: "forks", downloads: "downloads" };
...
const flat = (r) => ({
  ...
  signals: { stars: r.signals.stars, tested: r.signals.tested, mentions: r.signals.mentions },
  stars: r.signals.stars, tested: r.signals.tested, mentions: r.signals.mentions, desc: r.desc,
});
