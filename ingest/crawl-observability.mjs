...
const records = [
  ...
  },
  {
    ...
    description: "OpenTelemetry-based observability for LLM applications. It auto-instruments OpenAI, Anthropic, LangChain, and 20+ providers with zero code changes.",
    license: "Apache-2.0",
    tags: ["opentelemetry", "tracing"],
  },
  {
  ...
  },
  {
    ...
    description: "Datadog's managed LLM Observability product. It traces LLM calls, monitors prompt/completion quality, detects anomalies, and integrates with existing APM.",
    license: "commercial",
    tags: ["managed", "apm"],
  },
  {
    ...
    description: "Honeycomb's OpenTelemetry-native observability platform: a high-cardinality event store ideal for tracing LLM pipelines and debugging slow agent traces.",
    license: "Apache-2.0",
    tags: ["opentelemetry", "tracing"],
  },
  {
  ...
  },
  {
    ...
    description: "Sentry's error and performance monitoring extended to LLM applications. It captures exceptions, latency, and AI token usage with OpenTelemetry integration.",
    license: "FSL-1.0",
    tags: ["errors", "apm"],
  },
  {
    ...
    description: "New Relic AI Monitoring instruments LLM calls end-to-end. It traces model invocations, measures token costs, and surfaces anomalies via the New Relic platform.",
    license: "commercial",
    tags: ["managed", "apm"],
  },
  {
  ...
  },
  {
    ...
    description: "Open-source LLM observability and prompt management platform. It tracks conversations, errors, costs, and user feedback for production AI applications.",
    license: "Apache-2.0",
    tags: ["logging", "evals"],
  },
  {
  ...
  },
  {
    ...
    description: "Open-source, OpenTelemetry-compliant LLM observability tool by Scale3Labs. It traces calls to all major LLM providers and frameworks with a self-hostable UI.",
    license: "AGPL-3.0",
    tags: ["opentelemetry", "tracing"],
  },
  {
  ...
  },
  {
    ...
    description: "Literal AI is an observability and evaluation platform for conversational AI. It captures multi-step threads, scores responses, and integrates with Chainlit.",
    license: "commercial",
    tags: ["tracing", "evals"],
  },
  {
    ...
    description: "Phospho is a text analytics and evaluation platform for LLM apps. It logs sessions, runs clustering, detects failures, and surfaces actionable insights.",
    license: "Apache-2.0",
  ...
  },
  {
    ...
    description: "Maxim AI is an evaluation and observability platform for AI agents. It supports multi-step trace analysis, prompt testing, and production quality monitoring.",
    license: "commercial",
    tags: ["evals", "agents"],
  },
  {
