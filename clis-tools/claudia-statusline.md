...
**Source:** https://github.com/hagan/claudia-statusline

> Generated from the Armory catalog. Full metadata lives in `brain/components/clis-tools/claudia-statusline.md`.
