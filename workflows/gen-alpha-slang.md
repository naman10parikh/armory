...
**Source:** https://github.com/sjnims/gen-alpha-output-style

> Generated from the Armory catalog. Full metadata lives in `brain/components/workflows/gen-alpha-slang.md`.
