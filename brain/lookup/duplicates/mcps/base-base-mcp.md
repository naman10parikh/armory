...
source_repo: base/base-mcp
source_url: https://github.com/base/base-mcp
license: unknown
...
renamed_to: base/base-mcp-legacy
---
## What it is
Base Network integration for onchain tools, allowing interaction with Base Network and Coinbase API for wallet management, fund transfers, smart contracts, and DeFi operations
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Finance & Fintech). See https://github.com/base/base-mcp. Pending verify -> promote.
