...
source_repo: 
source_url: https://awslabs.github.io/mcp/servers/aws-knowledge-mcp-server/
license: unknown
...
See [Smithery](https://smithery.ai/server/FaresYoussef94/aws-knowledge-mcp) for the install config.
