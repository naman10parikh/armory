...
source_repo: matin/garth-mcp-server
source_url: https://github.com/matin/garth-mcp-server
license: unknown
...
renamed_to: matin/garth-mcp-server
---
## What it is
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/matin/garth-mcp-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/matin-garth). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
