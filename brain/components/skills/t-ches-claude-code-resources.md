...
## Source
Migrated from the awesome-claude-code resources table (category: Agent Skills). See https://github.com/glittercowboy/taches-cc-resources. Pending verify -> promote.
