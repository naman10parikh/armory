...
source_repo: avifenesh/agentsys
source_url: https://github.com/avifenesh/agentsys
license: MIT
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: Agent Skills). See https://github.com/avifenesh/agentsys. Pending verify -> promote.
