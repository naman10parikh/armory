...
## Source
Migrated from the awesome-claude-code resources table (category: Agent Skills). See https://github.com/K-Dense-AI/claude-scientific-skills. Pending verify -> promote.
