...
## Source
Migrated from the awesome-claude-code resources table (category: Agent Skills). See https://github.com/zarazhangrui/codebase-to-course. Pending verify -> promote.
