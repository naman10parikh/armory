...
## Source
Migrated from the awesome-claude-code resources table (category: Hooks). See https://github.com/bartolli/claude-code-typescript-hooks. Pending verify -> promote.
