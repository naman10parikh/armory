...
source_url: https://github.com/dl-ezo/claude-code-sub-agents/blob/main/cicd-builder.md
license: unknown
cli_compat: [claude]
maturity: beta
stars: null
...
## Notes
Extracted from [`dl-ezo/claude-code-sub-agents`](https://github.com/dl-ezo/claude-code-sub-agents/blob/main/cicd-builder.md). Pending verify -> promote.
