...
source_url: https://github.com/affaan-m/ecc/blob/main/agents/kotlin-reviewer.md
license: MIT
...
Vendored from `affaan-m/ecc` (`subagents`). See the source: https://github.com/affaan-m/ecc/blob/main/agents/kotlin-reviewer.md
