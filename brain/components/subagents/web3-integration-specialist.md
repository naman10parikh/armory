...
source_url: https://github.com/davila7/claude-code-templates/blob/main/cli-tool/components/agents/blockchain-web3/web3-integration-specialist.md
license: MIT
cli_compat: [claude]
maturity: beta
stars: null
...
curl -sL https://raw.githubusercontent.com/davila7/claude-code-templates/main/cli-tool/components/agents/blockchain-web3/web3-integration-specialist.md -o .claude/agents/web3-integration-specialist.md
```

## Notes
Extracted from [`davila7/claude-code-templates`](https://github.com/davila7/claude-code-templates/blob/main/cli-tool/components/agents/blockchain-web3/web3-integration-specialist.md) — blockchain-web3 category. Type: subagents. Pending verify -> promote.
