...
source_url: https://github.com/wshobson/agents/blob/main/plugins/unit-testing/agents/debugger.md
license: MIT
cli_compat: [claude]
maturity: beta
stars: null
...
## Notes
Extracted from [`wshobson/agents`](https://github.com/wshobson/agents/blob/main/plugins/unit-testing/agents/debugger.md). Plugin: `unit-testing`. Pending verify -> promote.
