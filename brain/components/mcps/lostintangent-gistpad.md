...
source_repo: lostintangent/gistpad-mcp
source_url: https://github.com/lostintangent/gistpad-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/lostintangent/gistpad-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/lostintangent-gistpad). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
