...
source_repo: f-is-h/mcp-easy-copy
source_url: https://github.com/f-is-h/mcp-easy-copy
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/f-is-h/mcp-easy-copy

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/fisheep-easy-copy). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
