...
source_repo: nouchix/PQC-Khepra-MCP
source_url: https://github.com/nouchix/PQC-Khepra-MCP
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/yfmsa1qi2l) for the install config.
