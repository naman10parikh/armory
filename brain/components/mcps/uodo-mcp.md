...
source_repo: pawelojdowski/uodo-mcp
source_url: https://github.com/pawelojdowski/uodo-mcp
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/tazsc973cn) for the install config.
