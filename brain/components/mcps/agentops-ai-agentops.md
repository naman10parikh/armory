...
source_repo: agentops-ai/agentops-mcp
source_url: https://github.com/agentops-ai/agentops-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/agentops-ai/agentops-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/agentops-ai-agentops). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
