...
source_repo: cwjgege/genflowai-codex-plugin
source_url: https://github.com/cwjgege/genflowai-codex-plugin
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/v2plqbg3os) for the install config.
