...
source_repo: Agundur-KDE/geo-scanner-mcp
source_url: https://github.com/Agundur-KDE/geo-scanner-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/l5mss7umcd) for the install config.
