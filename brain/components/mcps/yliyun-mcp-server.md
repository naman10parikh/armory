...
source_repo: qjloong/yliyun-mcp-server
source_url: https://github.com/qjloong/yliyun-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/qpau12zi3t) for the install config.
