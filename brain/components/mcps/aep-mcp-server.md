...
source_repo: Focus-GTS/aep-mcp-server
source_url: https://github.com/Focus-GTS/aep-mcp-server
...
See [Glama](https://glama.ai/mcp/servers/a9nqgnwdmj) for the install config.
