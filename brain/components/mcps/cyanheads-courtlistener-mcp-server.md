...
source_repo: cyanheads/courtlistener-mcp-server
source_url: https://github.com/cyanheads/courtlistener-mcp-server
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/ikb4c53axp) for the install config.
