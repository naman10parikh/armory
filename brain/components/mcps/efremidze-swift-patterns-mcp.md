...
source_repo: efremidze/swift-patterns-mcp
source_url: https://github.com/efremidze/swift-patterns-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://github.com/efremidze/swift-patterns-mcp. Pending verify -> promote.
