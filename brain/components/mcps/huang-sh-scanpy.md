...
source_repo: huang-sh/scmcp
source_url: https://github.com/huang-sh/scmcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/huang-sh/scmcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/huang-sh-scanpy). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
