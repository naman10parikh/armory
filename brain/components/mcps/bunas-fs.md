...
source_repo: bunasq/fs
source_url: https://github.com/bunasq/fs
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/bunasq/fs

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/bunas-fs). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
