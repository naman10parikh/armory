...
source_repo: blakerouse/ssh-mcp
source_url: https://github.com/blakerouse/ssh-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Coding Agents). See https://github.com/blakerouse/ssh-mcp. Pending verify -> promote.
