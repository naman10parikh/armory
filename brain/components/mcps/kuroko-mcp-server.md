...
source_repo: nguyenthdat/kuroko
source_url: https://github.com/nguyenthdat/kuroko
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/rebcmkajke) for the install config.
