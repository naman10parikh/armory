...
source_repo: skyvanguard/mcp-vanguard
source_url: https://github.com/skyvanguard/mcp-vanguard
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/okivwaeytt) for the install config.
