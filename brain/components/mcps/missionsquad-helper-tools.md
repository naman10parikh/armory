---
name: missionsquad-helper-tools
type: mcps
description: >
...
source_url: https://github.com/missionsquad/mcp-helper-tools
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/missionsquad/mcp-helper-tools

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/missionsquad-helper-tools). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
