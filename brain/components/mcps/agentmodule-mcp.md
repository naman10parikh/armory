...
source_repo: AgentModule/mcp
source_url: https://github.com/AgentModule/mcp
license: unknown
...
stars: 2
forks: 0
pushed_at: "2026-04-04T02:42:50Z"
---
## What it is
Agent-native knowledge infrastructure. Deterministic, vertical-specific knowledge bases engineered for autonomous agent consumption via MCP. Ethics module (22 modules, EU AI Act mapped) included with every membership. Free 24hr ethics trial.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Knowledge & Memory). See https://github.com/AgentModule/mcp. Pending verify -> promote.
