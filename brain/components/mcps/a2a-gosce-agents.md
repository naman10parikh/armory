...
source_repo: mikerawsonnz/gosce-agents
source_url: https://github.com/mikerawsonnz/gosce-agents
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/wztz4q9mvi) for the install config.
