...
source_repo: sptmru/lastfm-mcp
source_url: https://github.com/sptmru/lastfm-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/trywjazr27) for the install config.
