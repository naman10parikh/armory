...
source_repo: esnark/blowback
source_url: https://github.com/esnark/blowback
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/esnark/blowback

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/esnark-blowback). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
