...
source_repo: piephai/mcp-image-optimizer
source_url: https://github.com/piephai/mcp-image-optimizer
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/cqsc9y7fje) for the install config.
