...
source_repo: hgn/mcp-server-notmuch
source_url: https://github.com/hgn/mcp-server-notmuch
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/fk5el07db6) for the install config.
