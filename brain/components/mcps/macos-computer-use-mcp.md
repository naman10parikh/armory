...
source_repo: yyyyyyyyiiiii/macos-computer-use-mcp
source_url: https://github.com/yyyyyyyyiiiii/macos-computer-use-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/czhdt8ocae) for the install config.
