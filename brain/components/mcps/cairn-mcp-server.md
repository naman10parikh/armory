...
source_repo: jasondostal/cairn-mcp
source_url: https://github.com/jasondostal/cairn-mcp
license: GPL 3.0
...
See [Glama](https://glama.ai/mcp/servers/huz5cv65wc) for the install config.
