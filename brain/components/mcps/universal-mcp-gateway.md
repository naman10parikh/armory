...
source_repo: Samuel-Mencke/mcp-gateway
source_url: https://github.com/Samuel-Mencke/mcp-gateway
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/khrlr4v5aw) for the install config.
