...
source_repo: rad-security/mcp-server
source_url: https://github.com/rad-security/mcp-server
license: unknown
...
stars: 6
forks: 5
pushed_at: "2026-08-14T14:41:43Z"
---
## What it is
MCP server for RAD Security, providing AI-powered security insights for Kubernetes and cloud environments. This server provides tools for querying the Rad Security API and retrieving security findings, reports, runtime data and many more.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/rad-security/mcp-server. Pending verify -> promote.
