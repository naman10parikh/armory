---
name: pinkpixel-notification-chimes
type: mcps
description: >
...
source_repo: pinkpixel-dev/notification-mcp
source_url: https://github.com/pinkpixel-dev/notification-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/pinkpixel-dev/notification-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/pinkpixel-notification-chimes). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
