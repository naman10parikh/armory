...
source_repo: thirdstrandstudio/mcp-xpath
source_url: https://github.com/thirdstrandstudio/mcp-xpath
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/thirdstrandstudio/mcp-xpath

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/jayarrowz-xpath). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
