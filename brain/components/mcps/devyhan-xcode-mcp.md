...
source_repo: devyhan/xcode-mcp
source_url: https://github.com/devyhan/xcode-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/devyhan/xcode-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/devyhan-xcode-mcp). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
