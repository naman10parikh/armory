...
source_repo: peopleworks/XAFLogicExplainer
source_url: https://github.com/peopleworks/XAFLogicExplainer
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/tnzvgbukeb) for the install config.
