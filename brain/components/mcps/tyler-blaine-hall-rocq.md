...
source_repo: angrysky56/mcp-rocq
source_url: https://github.com/angrysky56/mcp-rocq
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/angrysky56/mcp-rocq

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/tyler-blaine-hall-rocq). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
