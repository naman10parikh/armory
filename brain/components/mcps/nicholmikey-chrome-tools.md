...
source_repo: nicholmikey/chrome-tools-mcp
source_url: https://github.com/nicholmikey/chrome-tools-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/nicholmikey/chrome-tools-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/nicholmikey-chrome-tools). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
