...
source_repo: nsvk13/forgejo-mcp-server
source_url: https://github.com/nsvk13/forgejo-mcp-server
license: GPL 3.0
...
See [Glama](https://glama.ai/mcp/servers/kbes5dwccs) for the install config.
