...
source_repo: okarin25/api-dev-agent-mcp
source_url: https://github.com/okarin25/api-dev-agent-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/k984d2hm81) for the install config.
