...
source_repo: xiaolaifeng/mcp-proxy-bridge
source_url: https://github.com/xiaolaifeng/mcp-proxy-bridge
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/flhft77ldx) for the install config.
