...
source_repo: lorenzo-cambiaghi/LynxMCP
source_url: https://github.com/lorenzo-cambiaghi/LynxMCP
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/xaovrcdbze) for the install config.
