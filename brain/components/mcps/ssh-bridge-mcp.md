...
source_repo: berixoo/ssh-bridge-mcp
source_url: https://github.com/berixoo/ssh-bridge-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/fsydu9dhd3) for the install config.
