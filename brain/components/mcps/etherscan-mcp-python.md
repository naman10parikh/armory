...
source_repo: FLock-io/etherscan-mcp-python
source_url: https://github.com/FLock-io/etherscan-mcp-python
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/tujeil9p6u) for the install config.
