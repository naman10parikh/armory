...
source_repo: naffss-eng/modular-rag-system
source_url: https://github.com/naffss-eng/modular-rag-system
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/oj0qt5pxtm) for the install config.
