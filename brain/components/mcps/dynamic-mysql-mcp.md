...
source_repo: fadlee/dynamic-mysql-mcp
source_url: https://github.com/fadlee/dynamic-mysql-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/zw46io6jwv) for the install config.
