...
source_repo: gitmaxd/dubco-mcp-server-npm
source_url: https://github.com/gitmaxd/dubco-mcp-server-npm
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/gitmaxd/dubco-mcp-server-npm

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/gitmaxd-dub-co). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
