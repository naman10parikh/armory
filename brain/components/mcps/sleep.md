...
source_repo: agentsworkingtogether/mcp-sleep
source_url: https://github.com/agentsworkingtogether/mcp-sleep
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/agentsworkingtogether/mcp-sleep

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/sleep). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
