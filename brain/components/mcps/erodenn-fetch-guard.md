...
source_repo: Erodenn/fetch-guard
source_url: https://github.com/Erodenn/fetch-guard
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/Erodenn/fetch-guard. Pending verify -> promote.
