...
source_repo: Pactlio-ai/pactlio-mcp
source_url: https://github.com/Pactlio-ai/pactlio-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/qsrvjlgydl) for the install config.
