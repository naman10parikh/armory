...
source_repo: kuiralabs/ada-wallet-cli
source_url: https://github.com/kuiralabs/ada-wallet-cli
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/eqw03bveeh) for the install config.
