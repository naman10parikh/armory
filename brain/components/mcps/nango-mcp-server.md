...
source_repo: LevSky22/nango-mcp-server
source_url: https://github.com/LevSky22/nango-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/i2a2kokvvc) for the install config.
