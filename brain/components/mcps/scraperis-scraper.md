...
source_repo: ai-quill/scraperis-mcp
source_url: https://github.com/ai-quill/scraperis-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/ai-quill/scraperis-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/scraperis-scraper). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
