...
source_repo: Steph-ux/x-mcp-playwright
source_url: https://github.com/Steph-ux/x-mcp-playwright
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/qjh0vz8bie) for the install config.
