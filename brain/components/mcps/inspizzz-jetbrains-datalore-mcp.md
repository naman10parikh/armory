...
source_repo: inspizzz/jetbrains-datalore-mcp
source_url: https://github.com/inspizzz/jetbrains-datalore-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://github.com/inspizzz/jetbrains-datalore-mcp. Pending verify -> promote.
