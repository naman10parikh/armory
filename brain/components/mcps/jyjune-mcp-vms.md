...
source_repo: jyjune/mcp_vms
source_url: https://github.com/jyjune/mcp_vms
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/jyjune/mcp_vms. Pending verify -> promote.
