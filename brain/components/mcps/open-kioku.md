...
source_repo: shivyadavus/open-kioku
source_url: https://github.com/shivyadavus/open-kioku
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/xu9a510huv) for the install config.
