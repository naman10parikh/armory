...
source_repo: stevermeister/dutch-tax-income-calculator-mcp
source_url: https://github.com/stevermeister/dutch-tax-income-calculator-mcp
license: unknown
...
tags: [glama, mcp]
forks: 0
pushed_at: "2026-08-18T07:29:39Z"
---
## What it is
Enables Dutch income tax calculations: converts gross to net salary, net to gross, compares multiple salary scenarios, and provides tax bracket data for supported years. Every result includes a detailed breakdown and a thetax.nl permalink.
...
See [Glama](https://glama.ai/mcp/servers/wwet2fahj4) for the install config.
