...
source_repo: cameronrye/activitypub-mcp
source_url: https://github.com/cameronrye/activitypub-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Search & Data Extraction). See https://github.com/cameronrye/activitypub-mcp. Pending verify -> promote.
