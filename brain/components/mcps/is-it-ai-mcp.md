...
source_repo: JohannsenLum/is-it-ai-mcp
source_url: https://github.com/JohannsenLum/is-it-ai-mcp
license: MIT License
...
tags: [glama, mcp]
forks: 0
pushed_at: "2026-08-20T05:47:53Z"
---
## What it is
An MCP server that reads a file's embedded C2PA Content Credential to report whether it declares AI generation or a real-world capture, and checks whether that declaration's signature still verifies against the file's current bytes.
...
See [Glama](https://glama.ai/mcp/servers/hq3aeekk68) for the install config.
