...
source_repo: AlexandDunk/frontdesk-data
source_url: https://github.com/AlexandDunk/frontdesk-data
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/zy99emtsi7) for the install config.
