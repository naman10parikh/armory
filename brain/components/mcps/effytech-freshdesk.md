...
source_repo: effytech/freshdesk_mcp
source_url: https://github.com/effytech/freshdesk_mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/effytech/freshdesk_mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/effytech-freshdesk). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
