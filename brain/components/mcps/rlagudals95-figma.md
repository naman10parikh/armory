...
source_repo: rlagudals95/mcp_figma
source_url: https://github.com/rlagudals95/mcp_figma
license: unknown
...
tags: [mcp, pulsemcp]
forks: 0
pushed_at: "2025-03-17T14:26:42Z"
---
## What it is
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/rlagudals95/mcp_figma

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/rlagudals95-figma). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
