...
source_repo: gpartin/WaveGuardClient
source_url: https://github.com/gpartin/WaveGuardClient
license: unknown
...
stars: 4
forks: 1
pushed_at: "2026-04-13T16:50:53Z"
---
## What it is
Physics-based anomaly detection via MCP. Uses Klein-Gordon wave equations on GPU to detect anomalies with high precision (avg 0.90). 9 tools: scan, fingerprint, compare, token risk, wallet profiling, volume check, price manipulation detection.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Data Science Tools). See https://github.com/gpartin/WaveGuardClient. Pending verify -> promote.
