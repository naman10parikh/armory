...
source_repo: falcoschaefer99-eng/canva-mcp-server
source_url: https://github.com/falcoschaefer99-eng/canva-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/yfloby6xwt) for the install config.
