...
source_repo: magicschoolm/mcp-utility-tools
source_url: https://github.com/magicschoolm/mcp-utility-tools
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/xdv235btvb) for the install config.
