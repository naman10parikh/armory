...
source_repo: PaytonWebber/sqlite-mcp
source_url: https://github.com/PaytonWebber/sqlite-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/rntnmph921) for the install config.
