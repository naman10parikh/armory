...
source_repo: contentfactory/eu-verify
source_url: https://github.com/contentfactory/eu-verify
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/hpg21r391j) for the install config.
