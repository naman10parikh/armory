...
source_repo: block/vscode-mcp
source_url: https://github.com/block/vscode-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/block/vscode-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/block-vscode). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
