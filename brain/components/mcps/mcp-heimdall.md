...
source_repo: caglarbozkurt/mcp-heimdall
source_url: https://github.com/caglarbozkurt/mcp-heimdall
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/higopssxae) for the install config.
