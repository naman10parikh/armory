...
source_repo: jefferyadventure519-byte/ja-local-kb
source_url: https://github.com/jefferyadventure519-byte/ja-local-kb
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/psvl2kbnbb) for the install config.
