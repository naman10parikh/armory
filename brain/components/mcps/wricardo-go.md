...
source_repo: wricardo/go-mcp
source_url: https://github.com/wricardo/go-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/wricardo/go-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/wricardo-go). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
