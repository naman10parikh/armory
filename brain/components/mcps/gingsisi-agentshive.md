...
source_repo: gingsisi/AgentsHive
source_url: https://github.com/gingsisi/AgentsHive
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/zwpolkulei) for the install config.
