...
source_repo: labyrinth-analytics/loreconvo
source_url: https://github.com/labyrinth-analytics/loreconvo
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/agou8x9cpn) for the install config.
