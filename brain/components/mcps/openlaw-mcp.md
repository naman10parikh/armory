...
source_repo: damankaur-dev/openlaw-mcp
source_url: https://github.com/damankaur-dev/openlaw-mcp
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/m4syubwa2z) for the install config.
