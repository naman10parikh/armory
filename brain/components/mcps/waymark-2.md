...
source_repo: waymark-network/waymark-mcp
source_url: https://github.com/waymark-network/waymark-mcp
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/dzexm4yefs) for the install config.
