...
source_repo: 0xDegenMo/lighter-mcp
source_url: https://github.com/0xDegenMo/lighter-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Finance & Fintech). See https://github.com/0xDegenMo/lighter-mcp. Pending verify -> promote.
