...
source_repo: arman1o1/mcp-db-explorer
source_url: https://github.com/arman1o1/mcp-db-explorer
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/pw854boq2k) for the install config.
