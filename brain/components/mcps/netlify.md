...
source_repo: netlify/netlify-mcp
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/netlify/netlify-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/netlify). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
