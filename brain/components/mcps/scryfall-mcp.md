...
source_repo: rotohun/scryfall-mcp
source_url: https://github.com/rotohun/scryfall-mcp
license: unknown
...
tags: [glama, mcp]
forks: 0
pushed_at: "2026-06-26T20:21:35Z"
---
## What it is
A Model Context Protocol server that exposes the Scryfall Magic: The Gathering API as tools for LLM clients, enabling card search, images, prices, sets, rulings, symbology, catalogs, and bulk data access.
...
See [Glama](https://glama.ai/mcp/servers/iox92a0ufo) for the install config.
