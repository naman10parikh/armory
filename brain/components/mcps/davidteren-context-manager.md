---
name: davidteren-context-manager
type: mcps
description: >
...
source_repo: davidteren/claude-server
source_url: https://github.com/davidteren/claude-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/davidteren/claude-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/davidteren-context-manager). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
