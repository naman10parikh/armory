...
source_repo: auth0/auth0-mcp-server
source_url: https://github.com/auth0/auth0-mcp-server
license: unknown
...
mentions: 1
forks: 46
pushed_at: "2026-08-28T08:14:45Z"
---
## What it is
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/auth0/auth0-mcp-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/auth0). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
