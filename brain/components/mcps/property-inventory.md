...
source_repo: Anneo22/agent-property-inventory
source_url: https://github.com/Anneo22/agent-property-inventory
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/fi2tusixkb) for the install config.
