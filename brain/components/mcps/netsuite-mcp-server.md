...
source_repo: dsvantien/netsuite-mcp-server
source_url: https://github.com/dsvantien/netsuite-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/i4hqubj4wc) for the install config.
