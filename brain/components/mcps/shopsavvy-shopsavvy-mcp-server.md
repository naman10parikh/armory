...
source_repo: shopsavvy/shopsavvy-mcp-server
source_url: https://github.com/shopsavvy/shopsavvy-mcp-server
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Search & Data Extraction). See https://github.com/shopsavvy/shopsavvy-mcp-server. Pending verify -> promote.
