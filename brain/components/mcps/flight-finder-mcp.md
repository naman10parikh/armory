...
source_repo: ellisp97/FlightFinderMCP
source_url: https://github.com/ellisp97/FlightFinderMCP
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/nuqfbcb2p9) for the install config.
