...
source_repo: urldna/mcp
source_url: https://github.com/urldna/mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/urldna/mcp. Pending verify -> promote.
