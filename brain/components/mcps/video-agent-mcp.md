...
source_repo: YansIlinta/video-agent-runtime
source_url: https://github.com/YansIlinta/video-agent-runtime
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/g76go0lhho) for the install config.
