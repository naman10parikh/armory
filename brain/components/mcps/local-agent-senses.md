...
source_repo: Scheme0/local-agent-senses
source_url: https://github.com/Scheme0/local-agent-senses
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/z9tlgpn5gi) for the install config.
