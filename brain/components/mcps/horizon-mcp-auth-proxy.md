...
source_repo: Razewang/mcp-proxy
source_url: https://github.com/Razewang/mcp-proxy
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/ktooziwcwz) for the install config.
