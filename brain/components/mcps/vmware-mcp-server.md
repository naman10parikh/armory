...
source_repo: adrianlizman/vmware-mcp-server
source_url: https://github.com/adrianlizman/vmware-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/k4blc2ypx3) for the install config.
