...
source_repo: entanglr/zettelkasten-mcp
source_url: https://github.com/entanglr/zettelkasten-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Knowledge & Memory). See https://github.com/entanglr/zettelkasten-mcp. Pending verify -> promote.
