...
source_repo: CodingSelim/mcp-scan
source_url: https://github.com/CodingSelim/mcp-scan
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/mv19uswpzh) for the install config.
