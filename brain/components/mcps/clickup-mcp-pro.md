...
source_repo: helbertparanhos/clickup-mcp-pro
source_url: https://github.com/helbertparanhos/clickup-mcp-pro
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/pmdt3s3vlt) for the install config.
