...
source_repo: JamesANZ/cross-llm-mcp
source_url: https://github.com/JamesANZ/cross-llm-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Knowledge & Memory). See https://github.com/JamesANZ/cross-llm-mcp. Pending verify -> promote.
