...
source_repo: AlgoChains/algochains-mcp-server
source_url: https://github.com/AlgoChains/algochains-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/q36vxo10nu) for the install config.
