...
source_repo: SangoAlgo/openbrowser
source_url: https://github.com/SangoAlgo/openbrowser
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/uehsexu008) for the install config.
