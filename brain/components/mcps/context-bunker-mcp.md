...
source_repo: tonghaoch/context-bunker-mcp
source_url: https://github.com/tonghaoch/context-bunker-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/errqpyd6hr) for the install config.
