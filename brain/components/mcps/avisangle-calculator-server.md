...
source_repo: avisangle/calculator-server
source_url: https://github.com/avisangle/calculator-server
license: unknown
...
stars: 6
forks: 4
pushed_at: "2025-09-19T17:31:36Z"
---
## What it is
A comprehensive Go-based MCP server for mathematical computations, implementing 13 mathematical tools across basic arithmetic, advanced functions, statistical analysis, unit conversions, and financial calculations.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Data Science Tools). See https://github.com/avisangle/calculator-server. Pending verify -> promote.
