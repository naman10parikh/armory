...
source_repo: Vitexus/mcp-server-webdriver
source_url: https://github.com/Vitexus/mcp-server-webdriver
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/gmzqa2nk37) for the install config.
