...
source_repo: mausrundung/mcp-explorer
source_url: https://github.com/mausrundung/mcp-explorer
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/mausrundung/mcp-explorer

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/project-explorer). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
