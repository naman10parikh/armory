...
source_repo: Rongxuan-Zhou/mujoco-mcp-server
source_url: https://github.com/Rongxuan-Zhou/mujoco-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/iegio4w2a3) for the install config.
