...
source_repo: teralynk/mcp-server
source_url: https://github.com/teralynk/mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/u4mq5eb96u) for the install config.
