...
source_repo: Caarlosgg/branchpoint
source_url: https://github.com/Caarlosgg/branchpoint
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/mcf2ai6edk) for the install config.
