...
source_repo: purodelphi/mcpfirebird
source_url: https://github.com/purodelphi/mcpfirebird
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/purodelphi/mcpfirebird

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/purodelphi-firebird). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
