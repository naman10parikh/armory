...
source_repo: westonhancock/orcha-mcp
source_url: https://github.com/westonhancock/orcha-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/mxkutexrgh) for the install config.
