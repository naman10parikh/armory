...
source_repo: labyrinth-analytics/loredocs
source_url: https://github.com/labyrinth-analytics/loredocs
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/qmso76cq1e) for the install config.
