...
source_repo: MatiasPujado/Project_Lens
source_url: https://github.com/MatiasPujado/Project_Lens
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/ywdaul4bbs) for the install config.
