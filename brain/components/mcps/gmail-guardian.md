...
source_repo: wyller/mcp-email-guardian
source_url: https://github.com/wyller/mcp-email-guardian
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/kc1e74pk9b) for the install config.
