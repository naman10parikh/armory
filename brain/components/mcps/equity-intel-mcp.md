...
source_repo: cstamigo-droid/equity-intel-mcp
source_url: https://github.com/cstamigo-droid/equity-intel-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/iwd9p7pyzm) for the install config.
