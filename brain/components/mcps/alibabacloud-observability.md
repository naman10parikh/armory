---
name: alibabacloud-observability
type: mcps
description: >
...
source_repo: aliyun/alibabacloud-observability-mcp-server
source_url: https://github.com/aliyun/alibabacloud-observability-mcp-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/aliyun/alibabacloud-observability-mcp-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/alibabacloud-observability). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
