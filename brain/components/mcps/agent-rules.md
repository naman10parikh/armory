...
source_repo: 4regab/agent-rules-mcp
source_url: https://github.com/4regab/agent-rules-mcp
license: unknown
...
## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/4regab-agent-rules). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
