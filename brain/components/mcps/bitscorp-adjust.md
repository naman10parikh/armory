...
source_repo: bitscorp-mcp/mcp-adjust
source_url: https://github.com/bitscorp-mcp/mcp-adjust
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/bitscorp-mcp/mcp-adjust

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/bitscorp-adjust). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
