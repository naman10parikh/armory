...
source_repo: debugg-ai/debugg-ai-mcp
source_url: https://github.com/debugg-ai/debugg-ai-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/debugg-ai/debugg-ai-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/debugg-ai-e2e-testing). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
