...
source_repo: dnakov/frida-mcp
source_url: https://github.com/dnakov/frida-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/dnakov/frida-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/dnakov-frida). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
