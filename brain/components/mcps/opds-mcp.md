...
source_repo: pastukhov/opds-mcp
source_url: https://github.com/pastukhov/opds-mcp
license: AGPL 3.0
...
tags: [glama, mcp]
forks: 1
pushed_at: "2026-07-01T12:06:10Z"
---
## What it is
An MCP server that lets an LLM browse, search, and download books from OPDS catalogs (e.g., Project Gutenberg, Standard Ebooks) using tools for feed navigation, full-text search, and acquisition link downloads.
...
See [Glama](https://glama.ai/mcp/servers/jnvasiqbzl) for the install config.
