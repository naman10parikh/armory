...
source_repo: AutomateLab-tech/citation-intelligence
source_url: https://github.com/AutomateLab-tech/citation-intelligence
license: unknown
...
stars: 8
forks: 0
pushed_at: "2026-06-08T10:51:16Z"
---
## What it is
What LLMs cite, for agents. Check which URLs Perplexity, Claude, ChatGPT, Gemini, Bing, and Google AI Overviews cite for any query. Self-hosted, BYO API key. Install via `npx @automatelab/citation-intelligence`.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Search & Data Extraction). See https://github.com/AutomateLab-tech/citation-intelligence. Pending verify -> promote.
