...
source_repo: LamboPoewert/mcp-server-madeonsol
source_url: https://github.com/LamboPoewert/mcp-server-madeonsol
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Finance & Fintech). See https://github.com/LamboPoewert/mcp-server-madeonsol. Pending verify -> promote.
