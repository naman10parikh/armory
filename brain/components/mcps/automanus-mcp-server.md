...
source_repo: automanus-io/mcp-server
source_url: https://github.com/automanus-io/mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/zg97k1hv5a) for the install config.
