...
source_repo: nickpending/mcp-recon
source_url: https://github.com/nickpending/mcp-recon
license: unknown
...
stars: 30
forks: 7
pushed_at: "2025-04-22T20:38:25Z"
---
## What it is
Conversational recon interface and MCP server powered by httpx and asnmap. Supports various reconnaissance levels for domain analysis, security header inspection, certificate analysis, and ASN lookup.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/nickpending/mcp-recon. Pending verify -> promote.
