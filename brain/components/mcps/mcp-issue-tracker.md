...
source_repo: HamzaOuadid/mcp-issue-tracker
source_url: https://github.com/HamzaOuadid/mcp-issue-tracker
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/n55t8bn1nh) for the install config.
