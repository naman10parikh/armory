...
source_repo: Arsie-codes/bridgemcp
source_url: https://github.com/Arsie-codes/bridgemcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/jvizdmovjc) for the install config.
