...
source_repo: praveendhra/mcp-devops-server
source_url: https://github.com/praveendhra/mcp-devops-server
license: MIT License
...
tags: [glama, mcp]
forks: 0
pushed_at: "2026-05-27T01:55:17Z"
---
## What it is
Enables AI assistants to perform DevOps tasks including Kubernetes management, cloud provider operations, CI/CD, security scanning, and infrastructure monitoring through natural language.
...
See [Glama](https://glama.ai/mcp/servers/ayy45ajqg9) for the install config.
