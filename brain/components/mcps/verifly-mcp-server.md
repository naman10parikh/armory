...
source_repo: james-sib/verifly-mcp-server
source_url: https://github.com/james-sib/verifly-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/xmzf9ssdke) for the install config.
