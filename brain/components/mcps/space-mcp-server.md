...
source_repo: AiAgentKarl/space-mcp-server
source_url: https://github.com/AiAgentKarl/space-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/isibhnv1im) for the install config.
