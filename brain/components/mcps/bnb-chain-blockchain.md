...
source_repo: bnb-chain/bnbchain-mcp
source_url: https://github.com/bnb-chain/bnbchain-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/bnb-chain/bnbchain-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/bnb-chain-blockchain). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
