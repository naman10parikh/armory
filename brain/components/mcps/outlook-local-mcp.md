...
source_repo: desek/outlook-local-mcp
source_url: https://github.com/desek/outlook-local-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/fcv05vhl87) for the install config.
