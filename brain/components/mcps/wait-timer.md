...
source_repo: 199-mcp/mcp-wait-timer
source_url: https://github.com/199-mcp/mcp-wait-timer
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/199-mcp/mcp-wait-timer

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/wait-timer). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
