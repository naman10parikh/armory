...
source_repo: infimium-ai/infimium-agent
source_url: https://github.com/infimium-ai/infimium-agent
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/q5nkdt4sxt) for the install config.
