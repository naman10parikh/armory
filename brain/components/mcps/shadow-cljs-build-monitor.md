---
name: shadow-cljs-build-monitor
type: mcps
description: >
...
source_repo: bigsy/shadow-cljs-mcp
source_url: https://github.com/bigsy/shadow-cljs-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/bigsy/shadow-cljs-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/shadow-cljs-build-monitor). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
