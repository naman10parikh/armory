...
source_repo: Mrquj/mcp-server-synology
source_url: https://github.com/Mrquj/mcp-server-synology
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/nl77oeok06) for the install config.
