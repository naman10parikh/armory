---
name: git-spice-documentation-search
type: mcps
description: >
...
source_repo: sach999/git-spice-help-mcp
source_url: https://github.com/sach999/git-spice-help-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/sach999/git-spice-help-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/git-spice-documentation-search). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
