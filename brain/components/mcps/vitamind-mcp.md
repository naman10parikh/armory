...
source_repo: JaviMaligno/vitamind-mcp
source_url: https://github.com/JaviMaligno/vitamind-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/jwx1thcvzc) for the install config.
