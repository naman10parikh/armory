...
source_repo: iosifache/annas-mcp
source_url: https://github.com/iosifache/annas-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/iosifache/annas-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/annas-archive). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
