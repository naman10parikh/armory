...
source_repo: carlosazaustre/advocu-mcp-server
source_url: https://github.com/carlosazaustre/advocu-mcp-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/carlosazaustre/advocu-mcp-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/carlosazaustre-advocu). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
