---
name: michsob-powerplatform-dataverse
type: mcps
description: >
...
source_repo: michsob/powerplatform-mcp
source_url: https://github.com/michsob/powerplatform-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/michsob/powerplatform-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/michsob-powerplatform-dataverse). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
