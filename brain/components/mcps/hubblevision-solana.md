...
source_repo: hubblevision/hubble-ai-mcp
source_url: https://github.com/hubblevision/hubble-ai-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/hubblevision/hubble-ai-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/hubblevision-solana). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
