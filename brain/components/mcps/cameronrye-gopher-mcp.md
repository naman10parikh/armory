...
source_repo: cameronrye/gopher-mcp
source_url: https://github.com/cameronrye/gopher-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Search & Data Extraction). See https://github.com/cameronrye/gopher-mcp. Pending verify -> promote.
