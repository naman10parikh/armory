...
source_repo: gokiwitech/pgwarden-mcp
source_url: https://github.com/gokiwitech/pgwarden-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/d7pq36fypj) for the install config.
