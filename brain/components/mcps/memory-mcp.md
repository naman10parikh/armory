...
source_repo: dannymaaz/memory-mcp
source_url: https://github.com/dannymaaz/memory-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/k9mtcc812z) for the install config.
