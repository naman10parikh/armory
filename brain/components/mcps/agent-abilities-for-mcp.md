...
source_repo: unaibamir/agent-abilities-for-mcp
source_url: https://github.com/unaibamir/agent-abilities-for-mcp
license: GPL 2.0
...
See [Glama](https://glama.ai/mcp/servers/y4t6eln4pg) for the install config.
