...
source_repo: Jktfe/serveMyAPI
source_url: https://github.com/Jktfe/serveMyAPI
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://github.com/Jktfe/serveMyAPI. Pending verify -> promote.
