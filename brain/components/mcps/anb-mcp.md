...
source_repo: kaka-milan-22/AnB_MCP
source_url: https://github.com/kaka-milan-22/AnB_MCP
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/bcs6ludxkw) for the install config.
