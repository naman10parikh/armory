---
name: diamond-it-615-browser-automation
type: mcps
description: >
...
source_repo: diamond-it-615/browser-mcp
source_url: https://github.com/diamond-it-615/browser-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/diamond-it-615/browser-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/diamond-it-615-browser-automation). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
