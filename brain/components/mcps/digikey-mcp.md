...
source_repo: itsyashk/digikey-mcp
source_url: https://github.com/itsyashk/digikey-mcp
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/ilrdadwzgf) for the install config.
