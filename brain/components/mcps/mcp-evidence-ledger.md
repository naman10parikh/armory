...
source_repo: brianpelow/mcp-evidence-ledger
source_url: https://github.com/brianpelow/mcp-evidence-ledger
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/xbl02y7qx0) for the install config.
