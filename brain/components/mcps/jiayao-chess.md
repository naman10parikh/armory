...
source_repo: jiayao/mcp-chess
source_url: https://github.com/jiayao/mcp-chess
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/jiayao/mcp-chess

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/jiayao-chess). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
