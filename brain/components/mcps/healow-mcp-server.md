...
source_repo: Voysi-IA/healow-mcp-server
source_url: https://github.com/Voysi-IA/healow-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/l2eq68pvvx) for the install config.
