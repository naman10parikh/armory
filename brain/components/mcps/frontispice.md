...
source_repo: bhind/raveil-frontispice
source_url: https://github.com/bhind/raveil-frontispice
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/rial1vfn90) for the install config.
