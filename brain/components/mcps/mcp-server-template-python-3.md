---
name: mcp-server-template-python-3
type: mcps
description: >
...
source_repo: pego29/mcp-server-python-mskl4du6
source_url: https://github.com/pego29/mcp-server-python-mskl4du6
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/bg1qmhlago) for the install config.
