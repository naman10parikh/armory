...
source_repo: RamidLab/mcp-service-template
source_url: https://github.com/RamidLab/mcp-service-template
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/p2bvfxgrz4) for the install config.
