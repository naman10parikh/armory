...
source_repo: McNews11/euroleague-open-data
source_url: https://github.com/McNews11/euroleague-open-data
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/pv05bd7tuz) for the install config.
