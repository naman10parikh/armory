...
source_repo: mar-co-za/mnevis-mcp
source_url: https://github.com/mar-co-za/mnevis-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/w5pm098fxe) for the install config.
