...
source_repo: alejandroviera/zephyr-squad-server-mcp
source_url: https://github.com/alejandroviera/zephyr-squad-server-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/s3ff1v3e6y) for the install config.
