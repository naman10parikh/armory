...
source_repo: puremd/puremd-mcp
source_url: https://github.com/puremd/puremd-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/puremd/puremd-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/puremd-web-access). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
