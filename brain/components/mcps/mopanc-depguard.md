...
source_repo: mopanc/depguard
source_url: https://github.com/mopanc/depguard
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/mopanc/depguard. Pending verify -> promote.
