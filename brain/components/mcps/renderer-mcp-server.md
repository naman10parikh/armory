...
source_repo: NishikantaRay/renderer-mcp-server
source_url: https://github.com/NishikantaRay/renderer-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/udd91kqsm0) for the install config.
