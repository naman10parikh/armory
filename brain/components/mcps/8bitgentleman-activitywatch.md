---
name: 8bitgentleman-activitywatch
type: mcps
description: >
...
source_repo: 8bitgentleman/activitywatch-mcp-server
source_url: https://github.com/8bitgentleman/activitywatch-mcp-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/8bitgentleman/activitywatch-mcp-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/8bitgentleman-activitywatch). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
