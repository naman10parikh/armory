...
source_repo: bsreeram08/git-commands-mcp
source_url: https://github.com/bsreeram08/git-commands-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/bsreeram08/git-commands-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/git-repository-browser). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
