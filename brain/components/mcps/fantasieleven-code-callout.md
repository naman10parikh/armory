...
source_repo: fantasieleven-code/callout
source_url: https://github.com/fantasieleven-code/callout
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://github.com/fantasieleven-code/callout. Pending verify -> promote.
