...
source_repo: optifeed/optifeed-radar
source_url: https://github.com/optifeed/optifeed-radar
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/qeqmch3x75) for the install config.
