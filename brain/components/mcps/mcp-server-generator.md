...
source_repo: SerhatUzbas/mcp-server-generator
source_url: https://github.com/SerhatUzbas/mcp-server-generator
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/tu1x30eo5p) for the install config.
