...
source_repo: janfincke/early-mcp-server
source_url: https://github.com/janfincke/early-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/hq6wds691p) for the install config.
