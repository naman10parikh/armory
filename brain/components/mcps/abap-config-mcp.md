...
source_repo: OCA-BE/MCP-Server-2
source_url: https://github.com/OCA-BE/MCP-Server-2
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/gq79j7gmb9) for the install config.
