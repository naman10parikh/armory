...
source_repo: useshortcut/mcp-server-shortcut
source_url: https://github.com/useshortcut/mcp-server-shortcut
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/useshortcut/mcp-server-shortcut

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/shortcut). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
