...
source_repo: zengzeruidd-a11y/amap-mcp-server
source_url: https://github.com/zengzeruidd-a11y/amap-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/zhek2byou3) for the install config.
