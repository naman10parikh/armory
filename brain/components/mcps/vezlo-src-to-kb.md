...
source_repo: vezlo/src-to-kb
source_url: https://github.com/vezlo/src-to-kb
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://github.com/vezlo/src-to-kb. Pending verify -> promote.
