...
source_repo: agent-hanju/char-index-mcp
source_url: https://github.com/agent-hanju/char-index-mcp
license: unknown
...
stars: 3
forks: 2
pushed_at: "2026-04-02T05:40:16Z"
---
## What it is
Precise character-level string indexing for LLMs. Provides tools for finding, extracting, and manipulating text by exact character position to solve position-based operations.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://github.com/agent-hanju/char-index-mcp. Pending verify -> promote.
