...
source_repo: ikaruce/code-agent-mcp
source_url: https://github.com/ikaruce/code-agent-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/mjued2dfia) for the install config.
