...
source_repo: enrique-z/agentdata-mcp-server
source_url: https://github.com/enrique-z/agentdata-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/c8fgq3cxgr) for the install config.
