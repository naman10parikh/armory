...
source_repo: frankdeno/flux-image-generator-mcp
source_url: https://github.com/frankdeno/flux-image-generator-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/frankdeno/flux-image-generator-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/flux-image-generator). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
