...
source_repo: muhannad-hash/mcp-shield
source_url: https://github.com/muhannad-hash/mcp-shield
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/muhannad-hash/mcp-shield. Pending verify -> promote.
