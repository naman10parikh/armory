...
source_repo: kajirita2002/honeycomb-mcp-server
source_url: https://github.com/kajirita2002/honeycomb-mcp-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/kajirita2002/honeycomb-mcp-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/honeycomb). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
