...
source_repo: UtahREIA/addevent-mcp-server
source_url: https://github.com/UtahREIA/addevent-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/yprlgyglwt) for the install config.
