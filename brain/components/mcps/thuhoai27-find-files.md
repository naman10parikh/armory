...
source_repo: thuhoai27/find-files-mcp
source_url: https://github.com/thuhoai27/find-files-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/thuhoai27/find-files-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/thuhoai27-find-files). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
