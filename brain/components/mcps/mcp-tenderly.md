...
source_repo: py-zoid/mcp-tenderly
source_url: https://github.com/py-zoid/mcp-tenderly
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/lwon2r8dg4) for the install config.
