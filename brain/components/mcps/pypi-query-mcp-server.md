...
source_repo: loonghao/pypi-query-mcp-server
source_url: https://github.com/loonghao/pypi-query-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/mmdivoygef) for the install config.
