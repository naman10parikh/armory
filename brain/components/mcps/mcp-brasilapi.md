...
source_repo: silasrm/mcp-brasilapi
source_url: https://github.com/silasrm/mcp-brasilapi
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/ss9upgm4nc) for the install config.
