...
source_repo: AvatarGanymede/ue5.7-mcp
source_url: https://github.com/AvatarGanymede/ue5.7-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/mh71mjwhva) for the install config.
