...
source_repo: bgigurtsis/aegis-mcp
source_url: https://github.com/bgigurtsis/aegis-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/h0dfzaf29v) for the install config.
