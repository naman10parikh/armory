...
source_repo: grounddocs/grounddocs
source_url: https://github.com/grounddocs/grounddocs
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/grounddocs/grounddocs

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/grounddocs). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
