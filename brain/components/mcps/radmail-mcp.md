...
source_repo: radmail-ai/radmail-mcp
source_url: https://github.com/radmail-ai/radmail-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/sbiautgmdb) for the install config.
