...
source_repo: redleaves/context-keeper
source_url: https://github.com/redleaves/context-keeper
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Knowledge & Memory). See https://github.com/redleaves/context-keeper. Pending verify -> promote.
