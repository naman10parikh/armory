...
source_repo: pablo-albaladejo/kaiord
source_url: https://github.com/pablo-albaladejo/kaiord
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/xh8k4s9evy) for the install config.
