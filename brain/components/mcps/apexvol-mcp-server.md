...
source_repo: ryansilk/apexvol-mcp
source_url: https://github.com/ryansilk/apexvol-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/zwp1odh9eb) for the install config.
