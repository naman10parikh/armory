...
source_repo: qianniuspace/mcp-security-audit
source_url: https://github.com/qianniuspace/mcp-security-audit
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/qianniuspace/mcp-security-audit

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/esx-security-audit). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
