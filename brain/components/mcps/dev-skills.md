...
source_repo: parikrut/mcp-toolkit
source_url: https://github.com/parikrut/mcp-toolkit
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/y7ow4y2xmi) for the install config.
