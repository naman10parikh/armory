...
source_repo: memorylane-dev/rush-gift-mcp
source_url: https://github.com/memorylane-dev/rush-gift-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/qtbztqs7tb) for the install config.
