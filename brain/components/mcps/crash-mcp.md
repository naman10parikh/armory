...
source_repo: AbdulAziz001/mcp-local
source_url: https://github.com/AbdulAziz001/mcp-local
license: unknown
...
tags: [glama, mcp]
forks: 0
pushed_at: "2026-04-03T14:18:59Z"
---
## What it is
A structured reasoning and problem-solving MCP server that helps track step-by-step analysis with confidence levels, branching, and revisions, ideal for complex multi-step tasks like code optimization and debugging.
...
See [Glama](https://glama.ai/mcp/servers/fym3lczrsl) for the install config.
