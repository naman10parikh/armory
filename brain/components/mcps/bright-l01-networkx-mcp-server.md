...
source_repo: Bright-L01/networkx-mcp-server
source_url: https://github.com/Bright-L01/networkx-mcp-server
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Data Science Tools). See https://github.com/Bright-L01/networkx-mcp-server. Pending verify -> promote.
