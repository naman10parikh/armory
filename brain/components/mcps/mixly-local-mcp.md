...
source_repo: ovoVHV/mixly-local-mcp
source_url: https://github.com/ovoVHV/mixly-local-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/x18lo3npjq) for the install config.
