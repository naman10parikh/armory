...
source_repo: halitartuc/phpustik
source_url: https://github.com/halitartuc/phpustik
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/mcovrayqbj) for the install config.
