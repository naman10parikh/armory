...
source_repo: yoda-digital/mcp-gitlab-server
source_url: https://github.com/yoda-digital/mcp-gitlab-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/yoda-digital/mcp-gitlab-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/nalyk-gitlab). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
