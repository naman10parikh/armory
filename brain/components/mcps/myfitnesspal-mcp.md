...
source_repo: JamsusMaximus/myfitnesspal-mcp
source_url: https://github.com/JamsusMaximus/myfitnesspal-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/vptrvn0mjm) for the install config.
