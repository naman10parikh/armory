...
source_repo: notx2wice/graphiti-folder
source_url: https://github.com/notx2wice/graphiti-folder
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/wygphizb6p) for the install config.
