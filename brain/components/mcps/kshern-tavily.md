...
source_repo: kshern/mcp-tavily
source_url: https://github.com/kshern/mcp-tavily
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/kshern/mcp-tavily

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/kshern-tavily). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
