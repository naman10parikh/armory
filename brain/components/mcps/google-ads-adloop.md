...
source_repo: kLOsk/adloop
source_url: https://github.com/kLOsk/adloop
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/trmhwmonjw) for the install config.
