...
source_repo: 
source_url: https://shadcnstudio.com/mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://shadcnstudio.com/mcp. Pending verify -> promote.
