...
source_repo: enjiapp/ai-marketing-agent
source_url: https://github.com/enjiapp/ai-marketing-agent
license: unknown
...
See [Smithery](https://smithery.ai/server/enji/ai-marketing-agent) for the install config.
