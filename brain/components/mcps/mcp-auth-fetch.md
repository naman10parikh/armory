...
source_repo: seeker-wen/mcp-auth-fetch
source_url: https://github.com/seeker-wen/mcp-auth-fetch
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/h5882rwob1) for the install config.
