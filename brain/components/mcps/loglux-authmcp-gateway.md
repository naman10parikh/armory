...
source_repo: loglux/authmcp-gateway
source_url: https://github.com/loglux/authmcp-gateway
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/loglux/authmcp-gateway. Pending verify -> promote.
