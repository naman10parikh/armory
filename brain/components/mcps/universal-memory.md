...
source_repo: YanAmorelli/universal-memory
source_url: https://github.com/YanAmorelli/universal-memory
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/ub5sotryxp) for the install config.
