...
source_repo: AIops-tools/Container-Host-AIops
source_url: https://github.com/AIops-tools/Container-Host-AIops
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/gxgoh9cahj) for the install config.
