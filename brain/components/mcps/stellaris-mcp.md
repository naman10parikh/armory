...
source_repo: GDM-Pixel/stellaris-code-search
source_url: https://github.com/GDM-Pixel/stellaris-code-search
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/et3d9erpqf) for the install config.
