...
source_repo: Docuplete/mcp-server
source_url: https://github.com/Docuplete/mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/xo0d728nz5) for the install config.
