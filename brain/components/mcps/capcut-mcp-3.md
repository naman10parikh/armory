...
source_repo: yabdulaziz2009-dev/capcut-mcp
source_url: https://github.com/yabdulaziz2009-dev/capcut-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/s3aucbuasn) for the install config.
