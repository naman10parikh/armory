...
source_repo: cinevva-engine/mcp
source_url: https://github.com/cinevva-engine/mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/s2yv7khje5) for the install config.
