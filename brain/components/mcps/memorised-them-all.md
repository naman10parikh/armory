...
source_repo: GRU-953/memorised-them-all
source_url: https://github.com/GRU-953/memorised-them-all
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/qnpihqtoo5) for the install config.
