...
source_repo: princeruhulofficial/mcp-context-manager
source_url: https://github.com/princeruhulofficial/mcp-context-manager
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/w1oh9ucmcd) for the install config.
