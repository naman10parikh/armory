...
source_repo: wooxogh/adr-mcp-setup
source_url: https://github.com/wooxogh/adr-mcp-setup
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://github.com/wooxogh/adr-mcp-setup. Pending verify -> promote.
