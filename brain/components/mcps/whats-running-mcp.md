...
source_repo: stcmain/whats-running-mcp
source_url: https://github.com/stcmain/whats-running-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/qa0f5lfvh1) for the install config.
