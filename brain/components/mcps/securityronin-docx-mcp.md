...
source_repo: SecurityRonin/docx-mcp
source_url: https://github.com/SecurityRonin/docx-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Knowledge & Memory). See https://github.com/SecurityRonin/docx-mcp. Pending verify -> promote.
