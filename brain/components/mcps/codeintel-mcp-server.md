...
source_repo: SecondLifes/code-intel
source_url: https://github.com/SecondLifes/code-intel
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/uxew78mgtk) for the install config.
