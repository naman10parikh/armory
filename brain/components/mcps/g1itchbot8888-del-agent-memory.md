...
source_repo: g1itchbot8888-del/agent-memory
source_url: https://github.com/g1itchbot8888-del/agent-memory
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Knowledge & Memory). See https://github.com/g1itchbot8888-del/agent-memory. Pending verify -> promote.
