...
source_repo: undercurrentai/aegis-mcp
source_url: https://github.com/undercurrentai/aegis-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/s0oei3t5ah) for the install config.
