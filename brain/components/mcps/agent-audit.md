...
source_repo: fullstackdegen/agent-audit
source_url: https://github.com/fullstackdegen/agent-audit
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/ghgifeiaqw) for the install config.
