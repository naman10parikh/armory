...
source_repo: nebula-contrib/nebulagraph-mcp-server
source_url: https://github.com/nebula-contrib/nebulagraph-mcp-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/nebula-contrib/nebulagraph-mcp-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/psiace-nebulagraph). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
