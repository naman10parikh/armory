---
name: java-debug-adapter-protocol
type: mcps
description: >
...
source_repo: igorrhamon/mcp_debugger
source_url: https://github.com/igorrhamon/mcp_debugger
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/igorrhamon/mcp_debugger

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/java-debug-adapter-protocol). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
