...
source_repo: nymrel/nymrel-mcp-hub
source_url: https://github.com/nymrel/nymrel-mcp-hub
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/op6s6h4j75) for the install config.
