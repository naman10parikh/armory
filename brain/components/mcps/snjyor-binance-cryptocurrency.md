---
name: snjyor-binance-cryptocurrency
type: mcps
description: >
...
source_repo: snjyor/binance-mcp
source_url: https://github.com/snjyor/binance-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/snjyor/binance-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/snjyor-binance-cryptocurrency). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
