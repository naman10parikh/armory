...
source_repo: Go-555/note-post-mcp-v2
source_url: https://github.com/Go-555/note-post-mcp-v2
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/e6gzi407bp) for the install config.
