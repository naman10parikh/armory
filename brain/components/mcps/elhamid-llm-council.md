...
source_repo: elhamid/llm-council
source_url: https://github.com/elhamid/llm-council
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Coding Agents). See https://github.com/elhamid/llm-council. Pending verify -> promote.
