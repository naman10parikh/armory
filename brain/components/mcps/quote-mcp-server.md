...
source_repo: zeqikong-ctrl/quote-mcp-server
source_url: https://github.com/zeqikong-ctrl/quote-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/ktsgtq26yv) for the install config.
