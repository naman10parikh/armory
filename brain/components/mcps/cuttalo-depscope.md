...
source_repo: cuttalo/depscope
source_url: https://github.com/cuttalo/depscope
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/cuttalo/depscope. Pending verify -> promote.
