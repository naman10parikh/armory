...
source_repo: tarunlnmiit/inbox-to-action
source_url: https://github.com/tarunlnmiit/inbox-to-action
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/fjo5es4cfq) for the install config.
