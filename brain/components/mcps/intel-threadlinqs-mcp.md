...
source_repo: threadlinqs-cmd/intelthreadlinqs-mcp
source_url: https://github.com/threadlinqs-cmd/intelthreadlinqs-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/mfu6pm3u74) for the install config.
