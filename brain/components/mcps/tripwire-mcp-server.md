...
source_repo: owen-25-AI/tripwire-mcp-server-tool
source_url: https://github.com/owen-25-AI/tripwire-mcp-server-tool
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/f4hgek1c0m) for the install config.
