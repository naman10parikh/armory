...
source_repo: bsmi021/mcp-chain-of-draft-server
source_url: https://github.com/bsmi021/mcp-chain-of-draft-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/bsmi021/mcp-chain-of-draft-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/bsmi021-chain-of-draft). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
