...
source_repo: small-lab-io/usehooks.io
source_url: https://github.com/small-lab-io/usehooks.io
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/small-lab-io/usehooks.io

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/olivierco-usehooksf97d). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
