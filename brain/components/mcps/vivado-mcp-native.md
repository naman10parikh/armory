...
source_repo: Arthurzxy/vivado_mcp_native
source_url: https://github.com/Arthurzxy/vivado_mcp_native
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/chws5b2pee) for the install config.
