...
source_repo: avisangle/jenkins-mcp-server
source_url: https://github.com/avisangle/jenkins-mcp-server
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://github.com/avisangle/jenkins-mcp-server. Pending verify -> promote.
