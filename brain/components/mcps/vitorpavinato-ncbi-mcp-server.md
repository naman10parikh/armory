...
source_repo: vitorpavinato/ncbi-mcp-server
source_url: https://github.com/vitorpavinato/ncbi-mcp-server
license: unknown
...
stars: 13
forks: 3
pushed_at: "2025-06-28T20:05:10Z"
---
## What it is
Comprehensive NCBI/PubMed literature search server with advanced analytics, caching, MeSH integration, related articles discovery, and batch processing for all life sciences and biomedical research.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Search & Data Extraction). See https://github.com/vitorpavinato/ncbi-mcp-server. Pending verify -> promote.
