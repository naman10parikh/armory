...
source_repo: StanimirTenev/qrp-mcp
source_url: https://github.com/StanimirTenev/qrp-mcp
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/sbrgiboego) for the install config.
