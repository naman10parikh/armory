...
source_repo: solatis/mcp-file-lens
source_url: https://github.com/solatis/mcp-file-lens
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/wdqzslttw0) for the install config.
