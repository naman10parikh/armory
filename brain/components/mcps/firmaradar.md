...
source_repo: Tiwas/firmaradar-mcp
source_url: https://github.com/Tiwas/firmaradar-mcp
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/padc3z1d45) for the install config.
