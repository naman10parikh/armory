...
source_repo: automation-ai-labs/mcp-wait
source_url: https://github.com/automation-ai-labs/mcp-wait
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/automation-ai-labs/mcp-wait

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/automation-ai-labs-wait). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
