...
source_repo: bluzername/lennys-quotes
source_url: https://github.com/bluzername/lennys-quotes
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Knowledge & Memory). See https://github.com/bluzername/lennys-quotes. Pending verify -> promote.
