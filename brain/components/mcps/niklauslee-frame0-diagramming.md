---
name: niklauslee-frame0-diagramming
type: mcps
description: >
...
source_repo: niklauslee/frame0-mcp-server
source_url: https://github.com/niklauslee/frame0-mcp-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/niklauslee/frame0-mcp-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/niklauslee-frame0-diagramming). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
