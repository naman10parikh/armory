...
source_repo: neno-is-ooo/mcp-openverse
source_url: https://github.com/neno-is-ooo/mcp-openverse
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/neno-is-ooo/mcp-openverse

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/openverse). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
