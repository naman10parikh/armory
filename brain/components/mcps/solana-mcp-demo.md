...
source_repo: metaplex-foundation/das-mcp-server
source_url: https://github.com/metaplex-foundation/das-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/pgvkg07o1p) for the install config.
