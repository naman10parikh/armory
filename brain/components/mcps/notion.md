...
source_repo: awkoy/notion-mcp-server
source_url: https://github.com/awkoy/notion-mcp-server
license: unknown
...
## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/awkoy-notion). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
