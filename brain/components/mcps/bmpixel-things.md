...
source_repo: wbopan/things-mcp
source_url: https://github.com/wbopan/things-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/wbopan/things-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/bmpixel-things). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
