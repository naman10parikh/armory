...
source_repo: optuna/optuna-mcp
source_url: https://github.com/optuna/optuna-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/optuna/optuna-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/optuna). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
