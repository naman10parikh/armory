...
source_repo: esinecan/instaffo-mcp-server
source_url: https://github.com/esinecan/instaffo-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/xeyscol4sp) for the install config.
