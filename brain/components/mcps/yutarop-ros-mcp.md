...
source_repo: Yutarop/ros-mcp
source_url: https://github.com/Yutarop/ros-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://github.com/Yutarop/ros-mcp. Pending verify -> promote.
