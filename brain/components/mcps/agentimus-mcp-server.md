...
source_repo: heera/agentimus
source_url: https://github.com/heera/agentimus
license: GPL 2.0
...
See [Glama](https://glama.ai/mcp/servers/dyvqiz0fxi) for the install config.
