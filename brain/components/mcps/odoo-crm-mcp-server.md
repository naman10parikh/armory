...
source_repo: KhalidAbdelrahman/agentic-odoo-mcp
source_url: https://github.com/KhalidAbdelrahman/agentic-odoo-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/cnia9s7j3b) for the install config.
