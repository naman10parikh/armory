...
source_repo: wazzan/mcp-coincap-jj
source_url: https://github.com/wazzan/mcp-coincap-jj
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/wazzan/mcp-coincap-jj

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/wazzan-coincap). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
