...
source_repo: hyperping/mcp-server
source_url: https://github.com/hyperping/mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/l1idzq7nvz) for the install config.
