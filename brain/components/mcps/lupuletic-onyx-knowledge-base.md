---
name: lupuletic-onyx-knowledge-base
type: mcps
description: >
...
source_repo: lupuletic/onyx-mcp-server
source_url: https://github.com/lupuletic/onyx-mcp-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/lupuletic/onyx-mcp-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/lupuletic-onyx-knowledge-base). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
