...
source_repo: AIops-tools/MySQL-AIops
source_url: https://github.com/AIops-tools/MySQL-AIops
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/a0195acd37) for the install config.
