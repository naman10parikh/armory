...
source_repo: rushikeshmore/CodeCortex
source_url: https://github.com/rushikeshmore/CodeCortex
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Knowledge & Memory). See https://github.com/rushikeshmore/CodeCortex. Pending verify -> promote.
