...
source_repo: IvanSkainet/arena-agent
source_url: https://github.com/IvanSkainet/arena-agent
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/hdpalkvg9s) for the install config.
