...
source_repo: ahmad-zurih/ds-mcp-server
source_url: https://github.com/ahmad-zurih/ds-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/siieaw4scs) for the install config.
