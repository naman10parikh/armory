...
source_repo: keepgoing-dev/mcp-server
source_url: https://github.com/keepgoing-dev/mcp-server
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Knowledge & Memory). See https://github.com/keepgoing-dev/mcp-server. Pending verify -> promote.
