...
source_repo: githunt-agent/githunt-mcp
source_url: https://github.com/githunt-agent/githunt-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/fvyellp5sq) for the install config.
