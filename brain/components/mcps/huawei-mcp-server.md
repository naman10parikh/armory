...
source_repo: HuaweiCloudDeveloper/mcp-server
source_url: https://github.com/HuaweiCloudDeveloper/mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/st90jp0ubn) for the install config.
