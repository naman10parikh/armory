...
source_repo: johnisanerd/Apify-Google-Maps-Photos-API
source_url: https://github.com/johnisanerd/Apify-Google-Maps-Photos-API
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/y1ps8jjpcp) for the install config.
