...
source_repo: Irohitjain/agentpay-pharos
source_url: https://github.com/Irohitjain/agentpay-pharos
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/olfmpa1k4a) for the install config.
