...
source_repo: alexxb2mg-svg/Mosaic
source_url: https://github.com/alexxb2mg-svg/Mosaic
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/qs71ubv0zb) for the install config.
