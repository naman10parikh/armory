...
source_repo: digitsouler/property-mcp-server
source_url: https://github.com/digitsouler/property-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/mkhwlj7yjk) for the install config.
