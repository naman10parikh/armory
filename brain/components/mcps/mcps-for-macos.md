...
source_repo: shaack/mcps-for-macos
source_url: https://github.com/shaack/mcps-for-macos
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/lfg3nlce4p) for the install config.
