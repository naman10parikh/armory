...
source_repo: JamesANZ/memory-mcp
source_url: https://github.com/JamesANZ/memory-mcp
license: unknown
...
stars: 21
forks: 11
pushed_at: "2025-12-10T04:24:04Z"
---
## What it is
An MCP server that stores and retrieves memories from multiple LLMs using MongoDB. Provides tools for saving, retrieving, adding, and clearing conversation memories with timestamps and LLM identification.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Knowledge & Memory). See https://github.com/JamesANZ/memory-mcp. Pending verify -> promote.
