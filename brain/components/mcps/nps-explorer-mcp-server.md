...
source_repo: Kyle-Ski/nps-explorer-mcp-server
source_url: https://github.com/Kyle-Ski/nps-explorer-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/c733sw80e6) for the install config.
