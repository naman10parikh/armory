...
source_repo: gbrigandi/mcp-server-wazuh
source_url: https://github.com/gbrigandi/mcp-server-wazuh
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/gbrigandi/mcp-server-wazuh. Pending verify -> promote.
