...
source_repo: flipt-io/mcp-server-flipt
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/flipt-io/mcp-server-flipt

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/flipt-io-feature-flags). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
