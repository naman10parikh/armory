...
source_repo: Lukeknow0/casper-agent-kit
source_url: https://github.com/Lukeknow0/casper-agent-kit
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/z7ulusywwp) for the install config.
