...
source_repo: synthaicode/XRefkit.MCP
source_url: https://github.com/synthaicode/XRefkit.MCP
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/snty5nc0ex) for the install config.
