---
name: forge-workspace-mcp-server
type: mcps
description: >
...
source_repo: mwdk2smb4r-ux/forge-product-agent
source_url: https://github.com/mwdk2smb4r-ux/forge-product-agent
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/st09uodt0a) for the install config.
