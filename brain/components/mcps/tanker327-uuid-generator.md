...
source_repo: tanker327/uuid-mcp
source_url: https://github.com/tanker327/uuid-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/tanker327/uuid-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/tanker327-uuid-generator). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
