---
name: aca-poc-mcp-tools-server-2
type: mcps
description: >
...
source_repo: anasmithdell/mcp_tools
source_url: https://github.com/anasmithdell/mcp_tools
license: MIT License
...
tags: [glama, mcp]
forks: 0
pushed_at: "2026-08-03T20:41:34Z"
---
## What it is
Provides financial audit reporting and ledger query tools for AI agents, enabling generation of compliance, risk, and transaction reports and querying of transaction data, balances, and summaries from an in-memory SQLite database via MCP.
...
See [Glama](https://glama.ai/mcp/servers/rv5rk4c6zm) for the install config.
