...
source_repo: azeth-protocol/mcp-server
source_url: https://github.com/azeth-protocol/mcp-server
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Finance & Fintech). See https://github.com/azeth-protocol/mcp-server. Pending verify -> promote.
