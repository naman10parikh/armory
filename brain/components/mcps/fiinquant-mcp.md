...
source_repo: luongndcoder/fiinquant-python-mcp
source_url: https://github.com/luongndcoder/fiinquant-python-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/sclqkqod2r) for the install config.
