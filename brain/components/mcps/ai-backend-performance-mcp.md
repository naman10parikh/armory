...
source_repo: robinafaruqia/ai-backend-performance-mcp
source_url: https://github.com/robinafaruqia/ai-backend-performance-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/kh7emh20iw) for the install config.
