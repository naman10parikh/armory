...
source_repo: krishnagutta/workday-mcp-reference
source_url: https://github.com/krishnagutta/workday-mcp-reference
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/y36aw85h04) for the install config.
