...
source_repo: cyanheads/federal-regulations-mcp-server
source_url: https://github.com/cyanheads/federal-regulations-mcp-server
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/bhniwflnar) for the install config.
