...
source_repo: redirhub/mcp-server
source_url: https://github.com/redirhub/mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/z2mypx78x5) for the install config.
