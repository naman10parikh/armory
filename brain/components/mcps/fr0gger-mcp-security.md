...
source_repo: fr0gger/MCP_Security
source_url: https://github.com/fr0gger/MCP_Security
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/fr0gger/MCP_Security. Pending verify -> promote.
