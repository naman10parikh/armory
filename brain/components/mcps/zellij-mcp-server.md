...
source_repo: GitJuhb/zellij-mcp-server
source_url: https://github.com/GitJuhb/zellij-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/xpwi7gfiet) for the install config.
