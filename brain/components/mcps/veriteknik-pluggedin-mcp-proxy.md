...
source_repo: VeriTeknik/pluggedin-mcp-proxy
source_url: https://github.com/VeriTeknik/pluggedin-mcp-proxy
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Aggregators). See https://github.com/VeriTeknik/pluggedin-mcp-proxy. Pending verify -> promote.
