...
source_repo: dmikushin/orca-slicer-mcp
source_url: https://github.com/dmikushin/orca-slicer-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/akrbptgzlg) for the install config.
