...
source_repo: albertm88/e-worker-mcp
source_url: https://github.com/albertm88/e-worker-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/pqgam1mzhg) for the install config.
