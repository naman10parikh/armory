...
source_repo: jdhart81/viridis-agent-fleet
source_url: https://github.com/jdhart81/viridis-agent-fleet
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/uqlv8na97n) for the install config.
