...
source_repo: sanyambassi/thales-cdsp-csm-mcp-server
source_url: https://github.com/sanyambassi/thales-cdsp-csm-mcp-server
license: MIT License
...
tags: [glama, mcp]
forks: 1
pushed_at: "2025-09-04T02:57:07Z"
---
## What it is
MCP server for Thales CipherTrust Secrets Management (powered by Akeyless) enabling secrets, DFC keys, authentication methods, roles, targets, analytics management, and intelligent app development with hardcoded secret migration.
...
See [Glama](https://glama.ai/mcp/servers/ydafm54p7i) for the install config.
