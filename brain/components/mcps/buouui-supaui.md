...
source_repo: buoooou/mcp-ui-gen
source_url: https://github.com/buoooou/mcp-ui-gen
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/buoooou/mcp-ui-gen

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/buouui-supaui). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
