...
source_repo: thupalo/sap-rfc-mcp-server
source_url: https://github.com/thupalo/sap-rfc-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/zno94hh689) for the install config.
