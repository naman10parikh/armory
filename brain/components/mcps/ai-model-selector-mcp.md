...
source_repo: barrymister/ai-model-selector-mcp
source_url: https://github.com/barrymister/ai-model-selector-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/dzkdkw3tuc) for the install config.
