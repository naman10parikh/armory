...
source_repo: raphysicst-create/korean-vocational-learning-map-mcp
source_url: https://github.com/raphysicst-create/korean-vocational-learning-map-mcp
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/m2tzp76px8) for the install config.
