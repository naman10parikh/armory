---
name: taylorwilsdon-quantconnect
type: mcps
description: >
...
source_repo: taylorwilsdon/quantconnect-mcp
source_url: https://github.com/taylorwilsdon/quantconnect-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/taylorwilsdon/quantconnect-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/taylorwilsdon-quantconnect). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
