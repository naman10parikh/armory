---
name: samvas-codes-dawshund-mcp
type: mcps
description: >
...
source_repo: samvas-codes/dawshund_mcp
source_url: https://github.com/samvas-codes/dawshund_mcp
license: unknown
...
stars: 1
forks: 3
pushed_at: "2025-11-10T05:33:13Z"
---
## What it is
An MCP server based on dAWShund to enumerate AWS IAM data, analyze effective permissions, and visualize access relationships across users, roles, and resources. Built for cloud security engineers who want fast, easy and effective insights into AWS identity risk.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/samvas-codes/dawshund_mcp. Pending verify -> promote.
