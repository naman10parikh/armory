...
source_repo: ViperJuice/mcp-gateway
source_url: https://github.com/ViperJuice/mcp-gateway
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Aggregators). See https://github.com/ViperJuice/mcp-gateway. Pending verify -> promote.
