...
source_repo: joconnell19/mcp-chart-forge
source_url: https://github.com/joconnell19/mcp-chart-forge
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/hqrd8j8ses) for the install config.
