...
source_repo: financialdatanet/mcp-server
source_url: https://github.com/financialdatanet/mcp-server
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Finance & Fintech). See https://github.com/financialdatanet/mcp-server. Pending verify -> promote.
