...
source_repo: carvectorio/carvector-mcp
source_url: https://github.com/carvectorio/carvector-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/y0y8k9elnk) for the install config.
