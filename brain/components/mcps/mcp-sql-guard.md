...
source_repo: tahasiddiquii/mcp-sql-guard
source_url: https://github.com/tahasiddiquii/mcp-sql-guard
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/mx4i6y8sgv) for the install config.
