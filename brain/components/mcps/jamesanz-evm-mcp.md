...
source_repo: JamesANZ/evm-mcp
source_url: https://github.com/JamesANZ/evm-mcp
license: unknown
...
stars: 3
forks: 3
pushed_at: "2026-07-18T11:00:00Z"
---
## What it is
An MCP server that provides complete access to Ethereum Virtual Machine (EVM) JSON-RPC methods. Works with any EVM-compatible node provider including Infura, Alchemy, QuickNode, local nodes, and more.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Finance & Fintech). See https://github.com/JamesANZ/evm-mcp. Pending verify -> promote.
