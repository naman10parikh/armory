...
source_repo: hechtcarmel/jetbrains-index-mcp-plugin
source_url: https://github.com/hechtcarmel/jetbrains-index-mcp-plugin
license: unknown
...
stars: 348
forks: 69
pushed_at: "2026-09-25T16:02:29Z"
---
## What it is
A JetBrains IDE plugin that exposes an MCP server, enabling AI coding assistants to leverage the IDE's indexing and refactoring capabilities (rename, safe delete, find references, call hierarchy, type hierarchy, diagnostics and more).
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://github.com/hechtcarmel/jetbrains-index-mcp-plugin. Pending verify -> promote.
