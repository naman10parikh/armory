...
source_repo: dOpensource/dsiprouter-mcp
source_url: https://github.com/dOpensource/dsiprouter-mcp
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/pmrg8xhx9x) for the install config.
