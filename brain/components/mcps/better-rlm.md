...
source_repo: logunovFGP/better-rlm
source_url: https://github.com/logunovFGP/better-rlm
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/v2r8376tn5) for the install config.
