...
source_repo: ettysekhon/google-maps-mcp-server
source_url: https://github.com/ettysekhon/google-maps-mcp-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/fwo9v1e96d) for the install config.
