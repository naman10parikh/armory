---
name: amekala-amazon-advertising
type: mcps
description: >
...
source_repo: amekala/adspirer-mcp-server
source_url: https://github.com/amekala/adspirer-mcp-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/amekala/adspirer-mcp-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/amekala-amazon-advertising). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
