...
source_repo: A-to-PC/blender-lab-mcp-client
source_url: https://github.com/A-to-PC/blender-lab-mcp-client
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/x14yvj6heb) for the install config.
