...
source_repo: yatinkoul/distill-mcp-v2
source_url: https://github.com/yatinkoul/distill-mcp-v2
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/ki59yn7oaa) for the install config.
