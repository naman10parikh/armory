...
source_repo: bnookala/mcp-cookiejar
source_url: https://github.com/bnookala/mcp-cookiejar
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/bnookala/mcp-cookiejar

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/cookie-jar). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
