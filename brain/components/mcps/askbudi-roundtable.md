...
source_repo: askbudi/roundtable
source_url: https://github.com/askbudi/roundtable
license: unknown
...
stars: 122
forks: 18
pushed_at: "2025-10-06T04:11:43Z"
---
## What it is
Meta-MCP server that unifies multiple AI coding assistants (Codex, Claude Code, Cursor, Gemini) through intelligent auto-discovery and standardized MCP interface, providing zero-configuration access to the entire AI coding ecosystem.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Aggregators). See https://github.com/askbudi/roundtable. Pending verify -> promote.
