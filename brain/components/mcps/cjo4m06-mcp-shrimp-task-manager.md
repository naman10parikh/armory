...
source_repo: cjo4m06/mcp-shrimp-task-manager
source_url: https://github.com/cjo4m06/mcp-shrimp-task-manager
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://github.com/cjo4m06/mcp-shrimp-task-manager. Pending verify -> promote.
