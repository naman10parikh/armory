...
source_repo: phuongrealmax/code-guardian
source_url: https://github.com/phuongrealmax/code-guardian
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Data Science Tools). See https://github.com/phuongrealmax/code-guardian. Pending verify -> promote.
