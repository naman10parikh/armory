---
name: emmron-gemini-code-analysis
type: mcps
description: >
...
source_repo: emmron/gemini-mcp
source_url: https://github.com/emmron/gemini-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/emmron/gemini-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/emmron-gemini-code-analysis). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
