...
source_repo: endorhq/cli
source_url: https://github.com/endorhq/cli
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Developer Tools). See https://github.com/endorhq/cli. Pending verify -> promote.
