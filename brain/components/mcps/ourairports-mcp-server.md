...
source_repo: cyanheads/ourairports-mcp-server
source_url: https://github.com/cyanheads/ourairports-mcp-server
license: Apache 2.0
...
See [Glama](https://glama.ai/mcp/servers/u5n1bhtgyw) for the install config.
