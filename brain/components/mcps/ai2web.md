...
source_repo: ai2web-foundation/ai2web-js
source_url: https://github.com/ai2web-foundation/ai2web-js
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/oss2yqkn7k) for the install config.
