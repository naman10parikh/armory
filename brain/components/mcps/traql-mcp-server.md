...
source_repo: traql/mcp-server
source_url: https://github.com/traql/mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/a3u3td8e46) for the install config.
