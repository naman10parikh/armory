---
name: himanshusanecha-osint-toolkit
type: mcps
description: >
...
source_repo: himanshusanecha/mcp-osint-server
source_url: https://github.com/himanshusanecha/mcp-osint-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/himanshusanecha/mcp-osint-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/himanshusanecha-osint-toolkit). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
