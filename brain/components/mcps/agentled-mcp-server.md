...
source_repo: Agentled/mcp-server
source_url: https://github.com/Agentled/mcp-server
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Workplace & Productivity). See https://github.com/Agentled/mcp-server. Pending verify -> promote.
