...
source_repo: awkoy/replicate-flux-mcp
source_url: https://github.com/awkoy/replicate-flux-mcp
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/awkoy/replicate-flux-mcp

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/awkoy-replicate-flux). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
