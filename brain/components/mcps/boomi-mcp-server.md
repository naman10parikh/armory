...
source_repo: RenEra-ai/boomi-mcp-server
source_url: https://github.com/RenEra-ai/boomi-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/c6484xu65x) for the install config.
