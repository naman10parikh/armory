...
source_repo: SavageCore/dashbrr-mcp
source_url: https://github.com/SavageCore/dashbrr-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/xw1ztawy39) for the install config.
