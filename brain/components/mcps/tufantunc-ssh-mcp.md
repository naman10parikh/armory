...
source_repo: tufantunc/ssh-mcp
source_url: https://github.com/tufantunc/ssh-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Coding Agents). See https://github.com/tufantunc/ssh-mcp. Pending verify -> promote.
