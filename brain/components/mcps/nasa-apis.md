...
source_repo: programcomputer/nasa-mcp-server
source_url: https://github.com/programcomputer/nasa-mcp-server
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/programcomputer/nasa-mcp-server

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/nasa-apis). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
