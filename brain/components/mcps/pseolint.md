...
source_repo: ouranos-labs/pseolint
source_url: https://github.com/ouranos-labs/pseolint
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/bumbxcqo9d) for the install config.
