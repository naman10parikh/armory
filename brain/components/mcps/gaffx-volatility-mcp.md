...
source_repo: Gaffx/volatility-mcp
source_url: https://github.com/Gaffx/volatility-mcp
license: unknown
...
stars: 52
forks: 7
pushed_at: "2025-07-09T14:14:53Z"
---
## What it is
MCP server for Volatility 3.x, allowing you to perform memory forensics analysis with AI assistant. Experience memory forensics without barriers as plugins like pslist and netscan become accessible through clean REST APIs and LLMs.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/Gaffx/volatility-mcp. Pending verify -> promote.
