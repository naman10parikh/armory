...
source_repo: JOSETRA44/INEI-mcp
source_url: https://github.com/JOSETRA44/INEI-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/pztbdkzdqo) for the install config.
