...
source_repo: rchanllc/picdefenseio-mcp-server
source_url: https://github.com/rchanllc/picdefenseio-mcp-server
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/jem1phzwe8) for the install config.
