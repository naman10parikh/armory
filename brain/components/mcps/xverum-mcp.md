...
source_repo: Xverum-LLC/xverum-mcp
source_url: https://github.com/Xverum-LLC/xverum-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/h7p08lxpmv) for the install config.
