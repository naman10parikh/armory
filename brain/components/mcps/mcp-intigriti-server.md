...
source_repo: jdc94/mcp-intigriti-server
source_url: https://github.com/jdc94/mcp-intigriti-server
license: unknown
...
See [Glama](https://glama.ai/mcp/servers/fyozpoka87) for the install config.
