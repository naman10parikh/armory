...
source_repo: DrBaher/contract-ops-mcp
source_url: https://github.com/DrBaher/contract-ops-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/uwh4526yqc) for the install config.
