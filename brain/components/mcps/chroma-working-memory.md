...
source_repo: djm81/chroma_mcp_server
source_url: https://github.com/djm81/chroma_mcp_server
license: unknown
...
## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/djm81-chroma-working-memory). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
