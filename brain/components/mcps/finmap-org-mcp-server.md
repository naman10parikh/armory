...
source_repo: finmap-org/mcp-server
source_url: https://github.com/finmap-org/mcp-server
license: unknown
...
stars: 12
forks: 4
pushed_at: "2026-08-02T08:38:14Z"
---
## What it is
[finmap.org](https://finmap.org/) MCP server provides comprehensive historical data from the US, UK, Russian and Turkish stock exchanges. Access sectors, tickers, company profiles, market cap, volume, value, and trade counts, as well as treemap and histogram visualizations.
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Finance & Fintech). See https://github.com/finmap-org/mcp-server. Pending verify -> promote.
