...
source_repo: Narasimhaponnada/mermaid-mcp
source_url: https://github.com/Narasimhaponnada/mermaid-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Architecture & Design). See https://github.com/Narasimhaponnada/mermaid-mcp. Pending verify -> promote.
