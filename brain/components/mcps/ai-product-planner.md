...
source_repo: codenameju/ai-product-planner
source_url: https://github.com/codenameju/ai-product-planner
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/my04wkumpg) for the install config.
