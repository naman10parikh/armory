...
source_repo: securityfortech/secops-mcp
source_url: https://github.com/securityfortech/secops-mcp
license: unknown
...
## Source
Migrated from the awesome-mcp-servers navigation directory (category: Security). See https://github.com/securityfortech/secops-mcp. Pending verify -> promote.
