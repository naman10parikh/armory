...
source_repo: eddmann/garmin-connect-mcp
source_url: https://github.com/eddmann/garmin-connect-mcp
license: MIT License
...
See [Glama](https://glama.ai/mcp/servers/jvy19za8nk) for the install config.
