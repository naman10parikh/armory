...
source_repo: mjpitz/mcp-rfc
source_url: https://github.com/mjpitz/mcp-rfc
license: unknown
...
See the source for the `mcpServers` config block (command + args). Source: https://github.com/mjpitz/mcp-rfc

## Notes
Discovered via the PulseMCP registry (https://www.pulsemcp.com/servers/mjpitz-rfc). License not declared in registry metadata — confirm before production use. Pending verify -> promote.
