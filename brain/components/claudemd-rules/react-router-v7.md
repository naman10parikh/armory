...
curl -sL https://github.com/PatrickJS/awesome-cursorrules/raw/main/rules/react-router-v7.mdc -o .cursor/rules/react-router-v7.mdc
```

## Notes
Migrated from [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/react-router-v7.mdc) (the largest Cursor-rules collection). Cursor `.mdc` rule files are valid agent-harness rules. Pending verify -> promote.
