...
curl -sL https://github.com/PatrickJS/awesome-cursorrules/raw/main/rules/nextjs-typescript-cursorrules-prompt-file.mdc -o .cursor/rules/nextjs-typescript-cursorrules-prompt-file.mdc
```

## Notes
Migrated from [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/nextjs-typescript-cursorrules-prompt-file.mdc) (the largest Cursor-rules collection). Cursor `.mdc` rule files are valid agent-harness rules. Pending verify -> promote.
