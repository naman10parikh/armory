...
curl -sL https://github.com/PatrickJS/awesome-cursorrules/raw/main/rules/fastapi.mdc -o .cursor/rules/fastapi.mdc
```

## Notes
Migrated from [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/fastapi.mdc) (the largest Cursor-rules collection). Cursor `.mdc` rule files are valid agent-harness rules. Pending verify -> promote.
