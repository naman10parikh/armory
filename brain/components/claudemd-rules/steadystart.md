...
source_url: https://github.com/steadycursor/steadystart/blob/main/CLAUDE.md
license: NOT_FOUND
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: CLAUDE.md Files). See https://github.com/steadycursor/steadystart/blob/main/CLAUDE.md. Pending verify -> promote.
