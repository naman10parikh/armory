...
source_repo: inkline/inkline
source_url: https://github.com/inkline/inkline/blob/main/CLAUDE.md
license: NOASSERTION
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: CLAUDE.md Files). See https://github.com/inkline/inkline/blob/main/CLAUDE.md. Pending verify -> promote.
