...
source_url: https://github.com/metabase/metabase/blob/master/CLAUDE.md
license: NOASSERTION
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: CLAUDE.md Files). See https://github.com/metabase/metabase/blob/master/CLAUDE.md. Pending verify -> promote.
