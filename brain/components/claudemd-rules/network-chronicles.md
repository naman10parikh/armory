...
source_repo: Fimeg/NetworkChronicles
source_url: https://github.com/Fimeg/NetworkChronicles/blob/legacy-v1/CLAUDE.md
license: MIT
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: CLAUDE.md Files). See https://github.com/Fimeg/NetworkChronicles/blob/legacy-v1/CLAUDE.md. Pending verify -> promote.
