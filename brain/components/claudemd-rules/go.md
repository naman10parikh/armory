...
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/go.mdc
license: CC0-1.0
...
## Notes
Migrated from [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/go.mdc) (the largest Cursor-rules collection). Cursor `.mdc` rule files are valid agent-harness rules. Pending verify -> promote.
