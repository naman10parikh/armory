...
curl -sL https://github.com/PatrickJS/awesome-cursorrules/raw/main/rules/solidity-react-blockchain-apps-cursorrules-prompt-.mdc -o .cursor/rules/solidity-react-blockchain-apps-cursorrules-prompt-.mdc
```

## Notes
Migrated from [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/solidity-react-blockchain-apps-cursorrules-prompt-.mdc) (the largest Cursor-rules collection). Cursor `.mdc` rule files are valid agent-harness rules. Pending verify -> promote.
