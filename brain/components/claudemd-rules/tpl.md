...
source_repo: KarpelesLab/tpl
source_url: https://github.com/KarpelesLab/tpl/blob/master/CLAUDE.md
license: MIT
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: CLAUDE.md Files). See https://github.com/KarpelesLab/tpl/blob/master/CLAUDE.md. Pending verify -> promote.
