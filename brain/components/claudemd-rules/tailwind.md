...
curl -sL https://github.com/PatrickJS/awesome-cursorrules/raw/main/rules/tailwind.mdc -o .cursor/rules/tailwind.mdc
```

## Notes
Migrated from [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/tailwind.mdc) (the largest Cursor-rules collection). Cursor `.mdc` rule files are valid agent-harness rules. Pending verify -> promote.
