...
source_repo: mikeyobrien/ralph-orchestrator
source_url: https://github.com/mikeyobrien/ralph-orchestrator
license: MIT
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: Workflows & Knowledge Guides). See https://github.com/mikeyobrien/ralph-orchestrator. Pending verify -> promote.
