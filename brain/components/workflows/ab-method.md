...
source_repo: ayoubben18/ab-method
...
## Source
Migrated from the awesome-claude-code resources table (category: Workflows & Knowledge Guides). See https://github.com/ayoubben18/ab-method. Pending verify -> promote.
