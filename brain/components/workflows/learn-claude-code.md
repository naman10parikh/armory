...
source_repo: shareAI-lab/learn-claude-code
...
## Source
Migrated from the awesome-claude-code resources table (category: Workflows & Knowledge Guides). See https://github.com/shareAI-lab/learn-claude-code. Pending verify -> promote.
