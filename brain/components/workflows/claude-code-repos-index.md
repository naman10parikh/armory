...
## Source
Migrated from the awesome-claude-code resources table (category: Workflows & Knowledge Guides). See https://github.com/danielrosehill/Claude-Code-Repos-Index. Pending verify -> promote.
