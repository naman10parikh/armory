...
## Source
Migrated from the awesome-claude-code resources table (category: Workflows & Knowledge Guides). See https://github.com/ThibautMelen/agentic-workflow-patterns. Pending verify -> promote.
