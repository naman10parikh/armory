...
source_repo: Helmi/claude-simone
...
## Source
Migrated from the awesome-claude-code resources table (category: Workflows & Knowledge Guides). See https://github.com/Helmi/claude-simone. Pending verify -> promote.
