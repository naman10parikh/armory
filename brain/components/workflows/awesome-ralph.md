...
source_repo: snwfdhmp/awesome-ralph
source_url: https://github.com/snwfdhmp/awesome-ralph
license: NOT_FOUND
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: Workflows & Knowledge Guides). See https://github.com/snwfdhmp/awesome-ralph. Pending verify -> promote.
