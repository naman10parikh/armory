...
source_repo: dredozubov/prd-generator
source_url: https://github.com/dredozubov/prd-generator
license: MIT
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: Slash-Commands). See https://github.com/dredozubov/prd-generator. Pending verify -> promote.
