...
source_url: https://github.com/affaan-m/ecc/blob/main/commands/gan-build.md
license: MIT
...
Vendored from `affaan-m/ecc` (`workflows`). See the source: https://github.com/affaan-m/ecc/blob/main/commands/gan-build.md
