...
## Source
Migrated from the awesome-claude-code resources table (category: Workflows & Knowledge Guides). See https://github.com/cheukyin175/learn-faster-kit. Pending verify -> promote.
