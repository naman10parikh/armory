...
## Source
Migrated from the awesome-claude-code resources table (category: Workflows & Knowledge Guides). See https://github.com/diet103/claude-code-infrastructure-showcase. Pending verify -> promote.
