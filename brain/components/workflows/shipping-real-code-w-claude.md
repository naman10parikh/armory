...
## Source
Migrated from the awesome-claude-code resources table (category: Workflows & Knowledge Guides). See https://diwank.space/field-notes-from-shipping-real-code-with-claude. Pending verify -> promote.
