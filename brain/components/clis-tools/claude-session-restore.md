...
source_repo: ZENG3LD/claude-session-restore
source_url: https://github.com/ZENG3LD/claude-session-restore
license: NOASSERTION
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: Tooling). See https://github.com/ZENG3LD/claude-session-restore. Pending verify -> promote.
