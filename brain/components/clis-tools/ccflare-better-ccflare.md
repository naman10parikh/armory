...
source_repo: tombii/better-ccflare
source_url: https://github.com/tombii/better-ccflare/
license: MIT
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: Tooling). See https://github.com/tombii/better-ccflare/. Pending verify -> promote.
