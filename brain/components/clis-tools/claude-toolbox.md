...
source_repo: serpro69/claude-toolbox
source_url: https://github.com/serpro69/claude-toolbox
license: NOASSERTION
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: Tooling). See https://github.com/serpro69/claude-toolbox. Pending verify -> promote.
