...
source_repo: Veraticus/cc-tools
source_url: https://github.com/Veraticus/cc-tools
license: NOT_FOUND
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: Tooling). See https://github.com/Veraticus/cc-tools. Pending verify -> promote.
