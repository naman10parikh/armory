...
source_url: https://github.com/slopus/happy
license: MIT
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: Tooling). See https://github.com/slopus/happy. Pending verify -> promote.
