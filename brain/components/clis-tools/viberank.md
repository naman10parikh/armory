...
source_repo: sculptdotfun/viberank
source_url: https://github.com/sculptdotfun/viberank
license: MIT
cli_compat: [claude]
maturity: beta
...
## Source
Migrated from the awesome-claude-code resources table (category: Tooling). See https://github.com/sculptdotfun/viberank. Pending verify -> promote.
