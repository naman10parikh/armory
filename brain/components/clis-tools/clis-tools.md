...
- [[skillsmith]] — create, test, and share agent skills
- [[agentbench]] — score and benchmark agent harnesses
- [[agentmoney]] — track and cap agent compute spend
- [[agentdial]] — universal agent identity and channels
- [[agent-booster]] — zero-LLM deterministic code transforms
- [[claude-harness]] — scaffold the full agent-native harness
