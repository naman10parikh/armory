...
**Source:** https://github.com/wshobson/agents/blob/main/plugins/error-debugging/agents/error-detective.md

> Generated from the Armory catalog. Full metadata lives in `brain/components/subagents/error-debugging-error-detective.md`.
