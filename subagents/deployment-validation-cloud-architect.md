...
**Source:** https://github.com/wshobson/agents/blob/main/plugins/deployment-validation/agents/cloud-architect.md

> Generated from the Armory catalog. Full metadata lives in `brain/components/subagents/deployment-validation-cloud-architect.md`.
