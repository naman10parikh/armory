...
**Source:** https://github.com/dl-ezo/claude-code-sub-agents/blob/main/security-analyzer.md

> Generated from the Armory catalog. Full metadata lives in `brain/components/subagents/security-analyzer.md`.
