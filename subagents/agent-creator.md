...
**Source:** https://github.com/dl-ezo/claude-code-sub-agents/blob/main/agent-creator.md

> Generated from the Armory catalog. Full metadata lives in `brain/components/subagents/agent-creator.md`.
